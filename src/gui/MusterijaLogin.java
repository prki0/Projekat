...
public class MusterijaLogin extends JFrame {
	...
	public MusterijaLogin(Prodavnica prodavnica) {
	...
	public void initActions() {
		btnCancel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				MusterijaLogin.this.dispose();
				MusterijaLogin.this.setVisible(false);
			}
		});
		...
		btnOk.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(korisnikoIme.equals("") || sifra.equals("")) {
					...
					Musterija prijavljeni = prodavnica.loginMusterija(korisnikoIme, sifra);
					if(prijavljeni == null) {
						JOptionPane.showMessageDialog(null, "Pogrešni login podaci.", "Greška", JOptionPane.WARNING_MESSAGE);
					}else {
						MusterijaLogin.this.dispose();
						MusterijaLogin.this.setVisible(false);
						MusterijaProzor mp = new MusterijaProzor(prodavnica, prijavljeni);
						mp.setVisible(true);
					}
				}
			}
